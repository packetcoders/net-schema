...
def is_documentation(instance) -> None:
...
def is_2byte_asn(instance) -> None:
...
def is_4byte_asn(instance) -> None:
...
def is_asn_int_notation(instance) -> None:
